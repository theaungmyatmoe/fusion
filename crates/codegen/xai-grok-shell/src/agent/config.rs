...
impl Default for EndpointsConfig {
    fn default() -> Self {
        Self {
            cli_chat_proxy_base_url: std::env::var("FUSION_CLI_CHAT_PROXY_BASE_URL")
                .or_else(|_| std::env::var("GROK_CLI_CHAT_PROXY_BASE_URL")).ok(),
            xai_api_base_url: std::env::var("FUSION_API_BASE_URL")
                .or_else(|_| std::env::var("FUSION_XAI_API_BASE_URL"))
